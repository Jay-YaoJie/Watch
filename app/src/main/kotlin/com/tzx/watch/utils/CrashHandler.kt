...
import com.tzx.watch.filekts.FileUtils
import com.tzx.watch.filekts.FinalValue
import java.io.File
...
//            uploadExceptionToServer()
    ...
    private fun dumpExceptionToSDCard(ex: Throwable) {
        ...
        val pi = pm.getPackageInfo("com.ftrd.flashlight", PackageManager.GET_ACTIVITIES);
        //应用的版本名称和版本号
