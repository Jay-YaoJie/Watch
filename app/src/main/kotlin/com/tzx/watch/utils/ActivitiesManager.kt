...
object ActivitiesManager {
    ...
    fun popActivity() {
        ...
        if (null != activity) {
            LogUtils.i("ActivitiesManager", "popActivity-->" + activity!!.javaClass.getSimpleName())
            activity!!.finish()
    ...
    fun popActivity(activity: Activity?) {
        ...
        if (null != activity) {
            LogUtils.i("ActivitiesManager", "popActivity-->" + activity.javaClass.simpleName)
            // activity.finish();
            mActivityStack!!.remove(activity)
            activity = null
        }
    ...
    fun pushActivity(activity: Activity) {
        ...
        LogUtils.i("ActivitiesManager", "pushActivity-->" + activity.javaClass.simpleName)
    }
    //关闭所有的Activity，并退出系统
